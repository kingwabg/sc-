    ...
    <div className="bg-white">
      <div className="grid grid-cols-1 gap-8 px-6 py-8 xl:grid-cols-[minmax(720px,920px)_220px]">
        <section className="max-w-[920px]">
          <div className="mb-5 grid min-h-[228px] grid-cols-[220px_minmax(0,1fr)_auto] items-start gap-8">
            <table className={cn("mt-[108px] w-[220px] border-collapse text-black", getDocFontClass(tableSettings.fontSize))}>
              <tbody>
