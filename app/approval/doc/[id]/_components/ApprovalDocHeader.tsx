...
import type { ApprovalRequest, ApprovalForm } from "@/lib/features/approval";
...
interface ApprovalDocHeaderProps {
  req: ApprovalRequest;
  formMeta?: ApprovalForm;
}

export function ApprovalDocHeader({ req, formMeta }: ApprovalDocHeaderProps) {
