...
export const MOCK_CHILDREN: Child[] = [
  ...
  { id: "c04", tenantId: "t_acme", name: "최예준", nameLast: "최", nameFirst: "예준", birthDate: "2019-11-15", gender: "M", capacityGroup: 30, grade: "초1", guardian: { name: "최미영", relation: "모", phone: "010-4567-8901" }, health: { allergies: [], medications: [], notes: "" }, enrolledAt: "2024-09-01", status: "active" },
  { id: "c05", tenantId: "t_acme", name: "정하은", nameLast: "정", nameFirst: "하은", birthDate: "2017-08-30", gender: "F", capacityGroup: 30, grade: "초3", guardian: { name: "정수진", relation: "모", phone: "010-5678-9012" }, health: { allergies: ["땅콩"], medications: [], notes: "" }, enrolledAt: "2024-03-02", status: "active" },
  { id: "c06", tenantId: "t_acme", name: "강유나", nameLast: "강", nameFirst: "유나", birthDate: "2018-06-18", gender: "F", capacityGroup: 30, grade: "초2", guardian: { name: "강동원", relation: "부", phone: "010-6789-0123" }, health: { allergies: [], medications: [], notes: "" }, enrolledAt: "2024-03-02", status: "active" },
  // 40명 정원
  { id: "c11", tenantId: "t_acme", name: "윤서아", nameLast: "윤", nameFirst: "서아", birthDate: "2017-01-22", gender: "F", capacityGroup: 40, grade: "초3", guardian: { name: "윤지영", relation: "모", phone: "010-1111-2222" }, health: { allergies: [], medications: [], notes: "" }, enrolledAt: "2024-03-02", status: "active" },
  { id: "c12", tenantId: "t_acme", name: "임도윤", nameLast: "임", nameFirst: "도윤", birthDate: "2016-04-11", gender: "M", capacityGroup: 40, grade: "초4", guardian: { name: "임성환", relation: "부", phone: "010-3333-4444" }, health: { allergies: ["게"], medications: [], notes: "" }, enrolledAt: "2023-09-01", status: "active" },
  { id: "c13", tenantId: "t_acme", name: "한지우", nameLast: "한", nameFirst: "지우", birthDate: "2018-12-03", gender: "F", capacityGroup: 40, grade: "초2", guardian: { name: "한승우", relation: "부", phone: "010-5555-6666" }, health: { allergies: [], medications: [], notes: "ADHD 진단" }, enrolledAt: "2024-03-02", status: "active" },
  { id: "c14", tenantId: "t_acme", name: "오현우", nameLast: "오", nameFirst: "현우", birthDate: "2019-07-19", gender: "M", capacityGroup: 40, grade: "초1", guardian: { name: "오은지", relation: "모", phone: "010-7777-8888" }, health: { allergies: [], medications: [], notes: "" }, enrolledAt: "2024-09-01", status: "active" },
  { id: "c15", tenantId: "t_acme", name: "서지안", nameLast: "서", nameFirst: "지안", birthDate: "2017-09-25", gender: "F", capacityGroup: 40, grade: "초3", guardian: { name: "서민정", relation: "모", phone: "010-9999-0000" }, health: { allergies: [], medications: [], notes: "" }, enrolledAt: "2024-03-02", status: "active" },
  // 50명 정원
  { id: "c21", tenantId: "t_acme", name: "권수호", nameLast: "권", nameFirst: "수호", birthDate: "2015-11-08", gender: "M", capacityGroup: 50, grade: "초5", guardian: { name: "권오수", relation: "부", phone: "010-2222-3333" }, health: { allergies: [], medications: [], notes: "" }, enrolledAt: "2023-09-01", status: "active" },
  { id: "c22", tenantId: "t_acme", name: "문채원", nameLast: "문", nameFirst: "채원", birthDate: "2016-03-14", gender: "F", capacityGroup: 50, grade: "초4", guardian: { name: "문지훈", relation: "부", phone: "010-4444-5555" }, health: { allergies: ["계란"], medications: [], notes: "" }, enrolledAt: "2023-09-01", status: "active" },
  { id: "c23", tenantId: "t_acme", name: "신우진", nameLast: "신", nameFirst: "우진", birthDate: "2017-06-02", gender: "M", capacityGroup: 50, grade: "초3", guardian: { name: "신미경", relation: "모", phone: "010-6666-7777" }, health: { allergies: [], medications: [], notes: "" }, enrolledAt: "2024-03-02", status: "active" },
  { id: "c24", tenantId: "t_acme", name: "백서연", nameLast: "백", nameFirst: "서연", birthDate: "2018-10-20", gender: "F", capacityGroup: 50, grade: "초2", guardian: { name: "백종현", relation: "부", phone: "010-8888-9999" }, health: { allergies: [], medications: [], notes: "" }, enrolledAt: "2024-03-02", status: "active" },
  { id: "c25", tenantId: "t_acme", name: "남하준", nameLast: "남", nameFirst: "하준", birthDate: "2019-04-17", gender: "M", capacityGroup: 50, grade: "초1", guardian: { name: "남은우", relation: "모", phone: "010-1212-3434" }, health: { allergies: ["밀가루"], medications: [], notes: "" }, enrolledAt: "2024-09-01", status: "active" },
];
